...
|:---:|:---|:---|
| [**frank_bot**](https://github.com/aquelemago/frank_bot) | Automação RPA para triagem de chamados no Soft4 e geração de relatórios. | `Python` · `Playwright` |
| [**eva_bot**](https://github.com/aquelemago/eva_bot) | Automação RPA para admissão digital no HCM SeniorX. | `Python` · `RPA` |
